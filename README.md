...
5. Run the application:
   ...
   ```
6. To use RAG, provide a file path of a PDF (e.g., `C:/users/.../file.pdf`).
   **Note:** Provide the file path without apostrophes.
...
Check out the following files in the repository:
